...
const inputClass = "w-full px-5 py-4 border-b-[1.5px] border-gray-600 focus:outline-none text-gray-900";
const wrapClass = "relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[1.5px] after:bg-yellow-500 after:scale-x-0 after:origin-center after:transition-transform after:duration-300 focus-within:after:scale-x-100";
...
export default function ContactSection() {
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center md:hidden">
            <span className="text-lg font-medium text-gray-700">have a Project in mind?</span>
            <h2 className="text-5xl md:text-5xl font-black uppercase tracking-tighter mt-3 leading-none"
              ...
              GET In<span className="text-yellow-500 pb-4 ml-3">TOUCH</span>
            </h2>
          </div>
          ...
          <div className="hidden md:block">
            ...
            <p className="text-lg text-gray-600 max-w-lg leading-relaxed">
              Have a project in mind? I'm currently available for freelance work and full-stack roles. Let's talk about your idea.
            </p>
          </div>
          ...
          <div className="bg-white h-[700px] border border-gray-300 py-8 px-6 md:px-8 md:p-10 rounded-md">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className={wrapClass}>
                    <input required name="name" value={formData.name} onChange={handleChange} type="text" placeholder="Steve jay" className={inputClass} />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold uppercase ml-1">Email Address</label>
                  <div className={wrapClass}>
                    <input required name="email" value={formData.email} onChange={handleChange} type="email" placeholder="john@company.com" className={inputClass} />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className={wrapClass}>
                  <input required name="phone" value={formData.phone} onChange={handleChange} type="tel" placeholder="+237 XXX XXX XXX" className={inputClass} />
                </div>
              </div>
  ...
  <textarea
    required name="name" value={formData.message} onChange={handleChange}
    rows={4} placeholder="Enter your message..."
    className={`${inputClass} resize-none block`}
  />
</div>
                </div>
              </div>
              ...
              <button disabled={loading} type="submit"
                ...
                {loading ? (<>Sending... <Loader2 className="w-5 h-5 animate-spin" /></>) : (<>Send Message <Send className="w-5 h-5" /></>)}
              </button>
            </form>
          </div>
